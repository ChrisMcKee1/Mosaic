...
class TestDataValidation:
    ...
    def test_entity_categories(self, mock_app):
        ...
        valid_categories = {
            "server", "plugin", "ingestion", "ai_agent", 
            "config", "model", "infrastructure", "test", "function"
        }
    ...
    def test_relationship_types(self, mock_app):
        ...
        valid_types = {
            "imports", "uses", "inherits", "coordinates", "creates", 
            "processes", "configures", "depends_on"
        }
    ...
    def test_data_consistency(self, mock_app):
        ...
        for rel in relationships:
            ...
            assert rel["source"] in entity_ids, f"Source {rel['source']} not found in entities"
            assert rel["target"] in entity_ids, f"Target {rel['target']} not found in entities"
