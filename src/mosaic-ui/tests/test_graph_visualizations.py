...
class TestD3GraphGeneration:
    ...
    def test_enhanced_d3_graph_creation(
    ...
    def test_d3_graph_data_structure(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
    ...
    def test_d3_interactive_features(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
    ...
    def test_classic_d3_graph_creation(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
...
class TestPlotlyGraphAnalytics:
    ...
    def test_plotly_interactivity_features(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
...
class TestGraphDataBinding:
    ...
    def test_empty_data_handling(self, mock_visualizations):
        ...
        d3_html = mock_visualizations.create_enhanced_d3_graph(
            empty_entities, empty_relationships
        )
        pyvis_html = mock_visualizations.create_pyvis_graph(
            empty_entities, empty_relationships
        )
        plotly_html = mock_visualizations.create_plotly_graph(
            empty_entities, empty_relationships
        )
    ...
    def test_data_validation_in_binding(self, mock_visualizations):
        ...
        invalid_html = mock_visualizations.create_enhanced_d3_graph(
            invalid_entities, []
        )
...
class TestInteractiveFeatures:
    ...
    def test_zoom_and_pan_features(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
    ...
    def test_node_selection_features(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
...
class TestVisualizationPerformance:
    ...
    def test_rendering_performance(self, mock_visualizations):
        ...
        # Small dataset
        small_entities = [
            {"id": f"node_{i}", "name": f"Node{i}", "category": "test"}
            for i in range(10)
        ]
        small_relationships = [
            {"source": f"node_{i}", "target": f"node_{i + 1}", "type": "test"}
            for i in range(9)
        ]
        ...
        medium_relationships = [
            {"source": f"node_{i}", "target": f"node_{(i + 1) % 50}", "type": "test"}
            for i in range(50)
        ]

        # Both should render without issues
        small_html = mock_visualizations.create_enhanced_d3_graph(
            small_entities, small_relationships
        )
        medium_html = mock_visualizations.create_enhanced_d3_graph(
            medium_entities, medium_relationships
        )
    ...
    def test_data_size_limits(self, mock_visualizations):
        ...
        large_relationships = [
            {"source": f"node_{i}", "target": f"node_{(i + 1) % 200}", "type": "test"}
            for i in range(300)
        ]

        # Should handle large datasets
        html = mock_visualizations.create_enhanced_d3_graph(
            large_entities, large_relationships
        )
...
class TestVisualizationAccessibility:
    ...
    def test_html_structure_accessibility(
        self, mock_visualizations, sample_graph_entities, sample_graph_relationships
    ):
