...
class MockMosaicSettings:
    ...
    def __init__(self, **kwargs):
        ...
        self.azure_openai_endpoint = kwargs.get('azure_openai_endpoint', 'https://test.openai.azure.com')
        ...
        self.azure_cosmos_endpoint = kwargs.get('azure_cosmos_endpoint', 'https://test.cosmos.azure.com')
        ...
        self.azure_redis_endpoint = kwargs.get('azure_redis_endpoint', 'test-redis.redis.cache.windows.net')
        ...
        self.azure_client_secret = kwargs.get('azure_client_secret', 'test-client-secret')
        
        # Memory configuration
        self.short_term_memory_ttl = kwargs.get('short_term_memory_ttl', 3600)
        self.memory_importance_threshold = kwargs.get('memory_importance_threshold', 0.7)
...
def clean_env():
    ...
    env_vars = [
        ...
        'AZURE_OPENAI_ENDPOINT', 'AZURE_COSMOS_DB_ENDPOINT',
        'AZURE_REDIS_ENDPOINT', 'AZURE_TENANT_ID', 'AZURE_CLIENT_ID',
        'OAUTH_ENABLED'
    ]
...
class TestMosaicSettingsInitialization:
    ...
    def test_azure_service_defaults(self):
        ...
        # OpenAI defaults
        assert 'text-embedding-ada-002' in settings.azure_openai_text_embedding_deployment_name
...
class TestConfigurationValidation:
    ...
    def test_invalid_memory_ttl(self):
        ...
        with pytest.raises(ValueError, match="Short-term memory TTL must be at least 60 seconds"):
