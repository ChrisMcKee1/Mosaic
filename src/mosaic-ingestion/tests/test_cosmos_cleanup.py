...
class TestCosmosDBCleaner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_settings.azure_cosmos_endpoint = "https://test-cosmos.documents.azure.com:443/"
    ...
    def test_get_container_stats_not_found(self):
        ...
        # Setup mocks
        self.cleaner.database = MagicMock()
        self.cleaner.database.get_container_client.side_effect = cosmos_exceptions.CosmosResourceNotFoundError()
...
class TestCosmosCleanupIntegration(unittest.TestCase):
    ...
    def test_run_cleanup_with_confirmation(self, mock_validate, mock_cleanup_container, 
                                         mock_get_stats, mock_list_containers, 
                                         mock_init_connection, mock_input):
...
if __name__ == "__main__":
    ...
    if args.coverage:
        ...
        suite = unittest.TestLoader().loadTestsFromTestCase(TestCosmosCleanupIntegration)
        unittest.TextTestRunner(verbosity=2).run(suite)
    else:
