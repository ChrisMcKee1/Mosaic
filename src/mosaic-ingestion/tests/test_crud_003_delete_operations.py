...
class TestGitDiffChangeDetection:
    ...
    async def test_get_changed_files_detects_deleted_files(self, ingestion_plugin, mock_git_repo):
        ...
        # Mock diff
        main_commit.diff.return_value = [deleted_item, modified_item, added_item, renamed_item]
        
        # Set up language extensions
        ingestion_plugin.language_extensions = {
            'python': ['.py']
        }
        
        # Call method
        changed_files = await ingestion_plugin._get_changed_files(repo, "feature-branch")
    ...
    async def test_get_changed_files_filters_unsupported_extensions(self, ingestion_plugin, mock_git_repo):
    ...
    async def test_get_changed_files_handles_no_main_branch(self, ingestion_plugin, mock_git_repo):
...
class TestSoftDeleteOperations:
    ...
    async def test_soft_delete_entity_handles_errors(self, ingestion_plugin):
        ...
        ingestion_plugin.knowledge_container.upsert_item = AsyncMock(side_effect=Exception("Database error"))
...
class TestCascadeDeleteOperations:
    ...
    async def test_cascade_delete_fileversion_entities(self, ingestion_plugin):
        ...
        code_entity1 = {"id": "code_1", "type": "CodeEntity", "file_version_id": "file_123"}
        code_entity2 = {"id": "code_2", "type": "CodeEntity", "file_version_id": "file_123"}
        relationship1 = {"id": "rel_1", "type": "Relationship", "source_id": "file_123", "target_id": "other"}
        ...
        # Call cascade delete
        await ingestion_plugin._cascade_delete_related_entities("file_123", "FileVersion", stats)
        ...
        for call in calls:
            ...
            assert "Cascade delete from FileVersion file_123" in entity["deletion_reason"]
    ...
    async def test_cascade_delete_non_fileversion_entity(self, ingestion_plugin):
        ...
        await ingestion_plugin._cascade_delete_related_entities("code_123", "CodeEntity", stats)
    ...
    async def test_cascade_delete_handles_query_errors(self, ingestion_plugin):
        ...
        ingestion_plugin.knowledge_container.query_items = MagicMock(side_effect=Exception("Query failed"))
...
class TestDeleteEntitiesByFilepath:
    ...
    async def ingestion_plugin(self):
        ...
        plugin._change_metadata = {
            ...
            'all_changed': ['deleted_file.py', 'modified_file.py', 'old_name.py', 'new_name.py']
        }
    ...
    async def test_delete_entities_distinguishes_operations(self, ingestion_plugin):
        ...
        ingestion_plugin.knowledge_container.query_items = MagicMock(return_value=entities)
        ...
        # Call method
        stats = await ingestion_plugin._delete_entities_by_filepath(changed_files, "update")
    ...
    async def test_delete_entities_returns_statistics(self, ingestion_plugin):
        ...
        expected_keys = [
            "files_processed", "entities_deleted", "cascade_deletions", 
            "soft_deletions", "errors", "audit_entries"
        ]
...
class TestIncrementalUpdateIntegration:
    ...
    async def test_process_incremental_update_includes_deletion_stats(self, ingestion_plugin):
        ...
        ingestion_plugin._delete_entities_by_filepath = AsyncMock(return_value=deletion_stats)
