...
"""
        ...
        prompt_config = PromptTemplateConfig(
            ...
            input_variables=[
                ...
                {
                    "name": "diagram_type",
                    "description": "Preferred diagram type",
                    "is_required": False,
                },
            ],
        )
    ...
    async def generate(self, description: str) -> str:
        ...
        try:
            ...
            result = await self.mermaid_generator.invoke(
                self.kernel, description=description, diagram_type=diagram_type
            )
            ...
            await self._store_diagram(
                diagram_id, description, mermaid_syntax, diagram_type
            )
        ...
        try:
            ...
            items = list(
                await asyncio.to_thread(
                    lambda: list(
                        self.diagram_container.query_items(
                            query=query,
    ...
    async def _store_diagram(
        self, diagram_id: str, description: str, mermaid_syntax: str, diagram_type: str
    ) -> None:
        ...
        try:
            item = {
                ...
                "metadata": {"source": "mermaid_generator", "version": "1.0"},
            }

            await asyncio.to_thread(self.diagram_container.create_item, body=item)
